...
public class CollectionManager {
    ...
    private LinkedHashSet<Vehicle> linkedHashSet = new LinkedHashSet<Vehicle>(0);
     ...
     */
    public boolean comparingId(Integer id) throws NotFindIdException {
        ...
        if (checkException == true) throw new NotFindIdException();
        return false;
    }
     ...
     */
    public boolean comparingFuelType(FuelType fuelType) {
        boolean checkException = true;
        for (Vehicle vehicle1 : linkedHashSet) {
        ...
        if (checkException == true) throw new IllegalArgumentException();
        return false;
    }
